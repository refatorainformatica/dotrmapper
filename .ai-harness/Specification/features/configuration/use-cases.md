...
## UC-01 — Comportamento principal de `configuration`

- **Actor:** usuário / consumidor da API
- **Given** o módulo `configuration` está disponível
- **When** a operação principal descrita em requirements é executada
- **Then** Customize individual members with `ForMember`

## UC-02 — Lacuna de teste

- **Actor:** engenharia
- **Given** não há testes unitários mapeados para `configuration`
