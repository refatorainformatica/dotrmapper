# Acceptance Criteria — dotrmapper-internal

> Nenhum teste unitário mapeado para `src/DotRMapper/Internal` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/DotRMapper/Internal` tests | pending |
