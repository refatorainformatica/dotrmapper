# Acceptance Criteria — dotrmapper-converters

> Nenhum teste unitário mapeado para `src/DotRMapper/Converters` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/DotRMapper/Converters` tests | pending |
