# Use Cases — converters

> Derivados de testes/código em 2026-08-24.

## UC-01 — Comportamento principal de `converters`

- **Actor:** usuário / consumidor da API
- **Given** o módulo `converters` está disponível
- **When** a operação principal descrita em requirements é executada
- **Then** Transform values with `ITypeConverter`

## UC-02 — Lacuna de teste

- **Actor:** engenharia
- **Given** não há testes unitários mapeados para `converters`
