# Acceptance Criteria — dotrmapper-obj

> Nenhum teste unitário mapeado para `src/DotRMapper/obj` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/DotRMapper/obj` tests | pending |
