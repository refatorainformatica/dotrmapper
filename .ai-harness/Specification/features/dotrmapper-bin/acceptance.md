# Acceptance Criteria — dotrmapper-bin

> Nenhum teste unitário mapeado para `src/DotRMapper/bin` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/DotRMapper/bin` tests | pending |
