# Acceptance Criteria — dotrmapper-resolvers

> Nenhum teste unitário mapeado para `src/DotRMapper/Resolvers` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/DotRMapper/Resolvers` tests | pending |
