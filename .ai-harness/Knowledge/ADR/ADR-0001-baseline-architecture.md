# ADR-0001: Baseline architecture — dotrmapper
...
O repositório `dotrmapper` precisa de uma linha-base arquitetural explícita para agentes e humanos.
Decisões foram inferidas do código, README e dependências em 2026-08-24.

## Decision

- **Estilo:** Clean Architecture / CQRS (.NET)
- **Integrações adotadas:** .NET SDK / solution
